...
void __slFfmta___root_fam();  // thread function for the root family, generated by the compiler based
...
static int start(int argc, char** argv) {
  ...
  create_fam(fc, &__slFfmta___root_fam, 0, 1, INHERIT_DEFAULT_PLACE);
